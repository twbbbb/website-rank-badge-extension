/*
//const LINK='https://data.similarweb.com/api/v1/data?domain=';
//const LINK='https://www.alexa.com/minisiteinfo/';
//const LINK='https://similarweb.com/website/';
const LINK='https://seoquake.publicapi.semrush.com/info.php?url='

let a=document.querySelectorAll('a');
let s=new Set();
for(x of a){
    try{
        s.add(new URL(x.href).hostname)
    }catch(e){}
}
console.log(Object.keys(s).length);

for(x of s){
    fetch(LINK+x).then(e=>console.log(e.status));
}
*/

/*
let MAX=100;
const LINK='http://xml.alexa.com/data?cli=10&url='
//const LINK='https://data.similarweb.com/api/v1/data?domain=';
//const LINK='https://www.alexa.com/minisiteinfo/';
//const LINK='https://similarweb.com/website/';
//const LINK='https://seoquake.publicapi.semrush.com/info.php?url=';
 function f(){
    for(i=0;i<MAX;i++){
        console.log(i);
        fetch(LINK+i+'.com').then(e=>console.log(e.status));
    }
}
f();
